...
public class ListaActivity extends AppCompatActivity {
    ...
    private void showPopupMenu(View view, int position) {
        ...
        popup.setOnMenuItemClickListener(item -> {
            ...
            if (item.getItemId() == R.id.menu_edit) {
                // Implementar edición
                Intent intent = new Intent(ListaActivity.this, EditarCultivoActivity.class);
                intent.putExtra("alias", verdura.getAlias());
                startActivity(intent);
                return true;
    ...
    private void deleteCultivo(String cultivoId) {
        db.collection("Verduras").document(cultivoId)
                .delete()
                .addOnSuccessListener(aVoid -> Toast.makeText(this, "Cultivo eliminado", Toast.LENGTH_SHORT).show())
